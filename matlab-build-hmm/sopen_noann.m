function [HDR,H1,h2] = sopen_noann(arg1,PERMISSION,CHAN,MODE,arg5,arg6)
% Note: May 2, 2013, Sridhar Sunderam.
% Modified from Biosig sopen.m: Changed line 899 to read first 1000
% annotations instead of all annotations.
...
%	$Id: sopen.m 2142 2009-07-02 13:38:00Z schloegl $
...
%                        t = fread(HDR.FILE.FID,inf,[int2str(HDR.AS.SPR(HDR.EDF.Annotations)*2),'*uchar=>uchar'],HDR.AS.bpb-HDR.AS.SPR(HDR.EDF.Annotations)*2);
                        t = fread(HDR.FILE.FID,1000,[int2str(HDR.AS.SPR(HDR.EDF.Annotations)*2),'*uchar=>uchar'],HDR.AS.bpb-HDR.AS.SPR(HDR.EDF.Annotations)*2);
